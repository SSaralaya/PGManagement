...
<body>
                ...
                <div class="content-wrapper w-100">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div id="printable-content">
                            ...
                            <h4 class="text-center"><img src="../assets/img/Logo/sdm_logo.png" width="40" alt=""> Sri Dharmasthala
                                Manjunatheshwara PU College Ujire.</h4>
                            ...
                            <div class="card p-3">
                                <table class="table table-bordered table-hover w-100 ">
                                    ...
                                    <tbody>
                                        <?php
                                        $sql1 = "select * from tblstudent order by messCode";
                            ...
                            <td>" . $row1['name'] . "</td>
                            <td>" . $row1['rollno'] . "</td>
                            <td>" . $row1['class'] . " " . $row1['combination'] . "</td>
                            <td>" . $row1['messCode'] . "-" . $row1['messName'] . "</td>
    ...
    <script>
        function printDiv(divId) {
            ...
            window.print();
            location.href = "all-student-list.php";
