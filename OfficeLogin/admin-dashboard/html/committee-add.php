...
function send_mail($name, $email)
{
  ...
  try {
    ...
    $mail->Subject = "SDM Paying Guest Committee \nPassword Details";
    $mail->Body = "Committee Member Name:" . $name . "\n Your Username is :" . $email . "\n Password is :" . $password;
    ...
    $str1 = "insert into tblstaff (username,pass,verify_token) values('" . $email . "','" . md5($password) . "','" . md5($verifytoken) . "')";
    include('../../../dbmain_conn.php');
    $maincon->query($str1);
  } catch (Exception $e) {
...
if (isset($_POST['add'])) {
  ...
  $str = "select * from tblcommittee where emailid='" . $email . "'";
  $res = $maincon->query($str);
  if ($res->num_rows > 0) {
    echo "<script>alert('Duplicate Entry')</script>";
  } else {
    $sql1 = "insert into tblcommittee values('" . $email . "','" . $role . "','" . $Cname . "','" . $cNo1 . "','" . $cNo2 . "','" . $new_name . "')";
    // echo $sql1;
    if ($maincon->query($sql1)) {
      if ((file_exists($_FILES['imageFile']['tmp_name'])) || (is_uploaded_file($_FILES['imageFile']['tmp_name']))) {
        move_uploaded_file($image, $destination);
      }
      send_mail($Cname, $email);
        ...
        <div class="app-brand demo">
          <a href="index.php" class="app-brand-link">
            <span class="app-brand-logo demo">
              <img src="../assets/img/Logo/sdm_logo.png" style="width: 30px;" alt="">
            </span>
            ...
            <div class="navbar-nav d-flex align-items-center justify-content-center align-items-center">
              <nav aria-label="breadcrumb  navbar-nav ">
                <ol class="breadcrumb mt-3">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Committee Member's</li>
                </ol>
              </nav>
            </div>
            <!-- /Search -->
            ...
            <div class="row d-flex justify-content-center">
              <div class="col-xl-6 ">
                ...
                <form action="" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
                  <div class="card mb-4">
                    <h5 class="card-header text-center">Add Committee Members</h5>
                    <div class="card-body">
                      <div class="mb-3 row">
                        <label for="html5-text-input" class="col-md-4 col-form-label">Name</label>
                        <div class="col-md-8">
                      ...
                      <div class="mb-3 row">
                        <label for="html5-email-input" class="col-md-4 col-form-label">Role</label>
                        <div class="col-md-8">
                          <select class="custom-select w-100 p-1 form-control text-dark" name="role" id="class" required>
                      ...
                      <div class="mb-3 row">
                        ...
                        <div class="col-md-8">
                          <input class="form-control" type="text" id="ph_no1" onkeyup="check_no(ph_no1);" minlength="10" maxlength="10" name="Contact1" required />
                        </div>
                      </div>


                      <div class="mb-3 row">
                        <label for="html5-text-input" class="col-md-4 col-form-label">Contact Number 2</label>
                        <div class="col-md-8">
                          <input class="form-control" type="text" id="ph_no2" onkeyup="check_no(ph_no2);" minlength="10" maxlength="10" name="Contact2" />
                        </div>
                      </div>
