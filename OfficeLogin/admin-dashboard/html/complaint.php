        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <div class="row d-flex justify-content-center">
              <h3 class="text-center">Complaints About PG</h3>
              <div class="col-xl-6 ">
                <?php
                                $sql1 = "select * from tblcomplaint where status='Unsolved'";
                                ...
                                if ($res1->num_rows > 0) {
                                   ...
                                   <div class='card-body'>
                                   <div class='mb-3 row'>
                                   <label for='html5-text-input' class='col-md-4 col-form-label'>Complaint Raiser</label>
                                   <div class='col-md-8'>
                                       <input class='form-control' type='number'  value='" . $row1['rollno'] . "' name='complaintId' readonly/>
                                   </div>
                               </div>";
                               ...
                               <label for='html5-text-input' class='col-md-4 col-form-label'>Mess Name</label>
                               <div class='col-md-8'>
                                   <input class='form-control' type='text'  value='" . $row2['messName'] . "' name='messName' readonly/>
                               </div>
                           </div>
                           <div class='mb-3 row'>
                           <label for='html5-text-input' class='col-md-4 col-form-label'>Issue</label>
                           <div class='col-md-8'>
