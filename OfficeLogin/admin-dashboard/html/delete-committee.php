...
if (isset($_POST['Delete'])) {
  $Uemail = $_POST['Uemail'];
  $dlt1 = "delete from tblcommittee where emailid='" . $Uemail . "'";
  $dlt2 = "delete from tblstaff where username='" . $Uemail . "'";
  if ($maincon->query($dlt1)) {
    if ($maincon->query($dlt2)) {
...
<head>
  ...
  <title>Delete Committee Members</title>
        ...
        <div class="content-wrapper">
          ...
          <div class="d-flex align-items-center justify-content-center">
            ...
            <form class="d-flex m-4 w-100 align-items-center justify-content-center" method="POST">
              <input class="form-control mr-sm-2 w-50" type="search" placeholder="Enter Committee Members Email ID......." aria-label="Search" name="email">
              <button class="btn bg-primary text-white " type="submit" style="margin-left: 0.2rem;" name="searchMember">Search</button>
            </form>
              ...
              <div class="row d-flex justify-content-center">
                ...
                <div class="col-xl-6 ">
                  ...
                  <form action="" method="POST">
                    <div class="card mb-4">
                      <h5 class="card-header text-center">Delete Committee Members</h5>
                      <div class="card-body">
                        <div class="mb-3 row">
                          <label for="html5-text-input" class="col-md-4 col-form-label">Email Id</label>
                          <div class="col-md-8">
                            <input class="form-control " type="text" value="<?php echo $email; ?>" id="html5-text-input" name="Uemail" readonly />
                          </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                          ...
                          <div class="col-md-8">
                            <input class="form-control" type="text" value="<?php echo $CName; ?>" name="Name" required readonly />
                          </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                          ...
                          <div class="col-md-8">
                            <input class="form-control" type="text" value="<?php echo $role; ?>" name="Role" required readonly />
                          </div>
                        </div>
