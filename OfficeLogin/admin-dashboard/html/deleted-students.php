        ...
        <div class="content-wrapper w-100">
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <td>" . $row1['aadharNo'] . "</td>";
                                            ...
                                            if ($row1['image'] != NULL) {
                                                $imgurl = "../../../PGLogin/PG-Owner/imgUploads/" . $row1['image'];
                                            } else {
                                                $imgurl = "../../../PGLogin/PG-Owner/imgUploads/default.png";
                                            }
                                            echo "
            <td class=' justify-content-center'>
                  ...
                  alt='Avatar' />
                                            ...
                                            $aurl = "../../../PGLogin/PG-Owner/aadharUploads/" . $row1['aadharImg'];
                                            echo "
              <td class='d-flex justify-content-center'>
                    <a target='_blank' href='" . $aurl . "'>
                    <img src='" . $aurl . "' class='rounded-3' style='width: 120px;height:150px'
                    alt='Aadhar Img' />
                    </a>
                </td>";
