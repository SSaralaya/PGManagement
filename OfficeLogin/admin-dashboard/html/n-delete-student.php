...
if (isset($_POST['delete'])) {
    $rollno = $_POST['stdno'];
    $sql3 = "delete from tbltemp where rollno='" . $rollno . "'";
      ...
      <div class="layout-page">
            ...
            <div class="navbar-nav d-flex align-items-center justify-content-center align-items-center">
              <nav aria-label="breadcrumb  navbar-nav ">
                <ol class="breadcrumb mt-3">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Delete Or Update Student</li>
                </ol>
              </nav>
            </div>
            <!-- /Search -->
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <div class="row">
              <h3 class="text-center">Delete Or Update Student </h3>

              <?php

                        $sql1 = "select * from tbltemp";
                        ...
                        <div class='card mb-4'> 
                        <div class='card-body date d-flex gap-3 align-items-center justify-content-between'>
                           <div class='d-flex gap-3 align-items-center justify-content-between'>
                           <label for='' class=''>Roll No:-</label>
                           <input class='form-control w-25' type='text'  value='" . $row1['rollno'] . "' name='stdno' readonly/> 
                           <label for=''>Student Name:-" . $row1['name'] . "</label>
                           ";


                                $sql2 = "select messName from tblmess where code='" . $row1['messCode'] . "'";
                                $res2 = $maincon->query($sql2);
                                if ($res2->num_rows > 0) {
                                    while ($row2 = $res2->fetch_assoc()) {
                                        echo "
                           <label for=''>PG Name:-" . $row2['messName'] . "</label>";
                                    }
                                }
                                echo "
                           <label for=''>PG Code:-" . $row1['messCode'] . "</label>
                           </div>
                           <div>
                            ...
                            <img class='w-50 h-50' src='../../../IMG/no-re.svg' alt='No Data Found'>
                        </div>";
                        }
