...
function send_mail($content)
{
    ...
    try {
        ...
        $mail->Subject = "SDM Paying Guest Committee Notice";
        $mail->Body = "Respected Sir/Madam " . $content;

        $sql1 = "select owner,emailid from tblmess";
        include('../../../dbmain_conn.php');
                            ...
                            <div class="row d-flex justify-content-center ">
                                <div class="col-xl-6">
                                    ...
                                    <form action="" method="POST">
                                        <div class="card mb-4">
                                            <h5 class="card-header text-center">NOTICE</h5>
                                            <div class="card-body">
                                                <div class="form-floating">
                                                    <textarea class="form-control h-100" rows="10" placeholder="Type the notice here" id="floatingTextarea2" name="notice"></textarea>
