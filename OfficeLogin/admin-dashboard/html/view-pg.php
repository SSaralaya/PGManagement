            ...
            <div class="navbar-nav d-flex align-items-center justify-content-center align-items-center">
              <nav aria-label="breadcrumb  navbar-nav ">
                <ol class="breadcrumb mt-3">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">PG Review</li>
                </ol>
              </nav>
            </div>
            <!-- /Search -->
        ...
        <div class="content-wrapper">
          ...
          <div class="d-flex align-items-center justify-content-center">
            ...
            <form class="d-flex m-4 w-100 align-items-center justify-content-center" method="POST">
              <input class="form-control mr-sm-2 w-50" type="text" placeholder="Enter the PG Code......."
                aria-label="Search" required name="searchcode">
          ...
          if (isset($_POST['updateSearch'])) {
            ...
            $messCode = $_POST['searchcode'];
            $sql2 = "select * from tblinspection where messCode='" . $messCode . "'";
            $res2 = $maincon->query($sql2);
            if ($res2->num_rows > 0) {
              $sql1 = "select messName as mName from tblmess where code='" . $messCode . "'";
              $res1 = $maincon->query($sql1);
              $messName = $res1->fetch_column();
              ...
              while ($row2 = $res2->fetch_assoc()) {
                echo "<p>Inspection Date:" . $row2['inspectionDate'] . "</p>";
                echo "<p>Inspection Team Member:" . $row2['vMember1'] . "</p>";
                if ($row2['vMember2'] != '') {
                  echo "<p>Inspection Team Member:" . $row2['vMember2'] . "</p>";
                }
                if ($row2['vMember3'] != '') {
                  echo "<p>Inspection Team Member:" . $row2['vMember3'] . "</p>";
                }
                if ($row2['vMember4'] != '') {
                  echo "<p>Inspection Team Member:" . $row2['vMember4'] . "</p>";
                }
                if ($row2['vMember5'] != '') {
                  echo "<p>Inspection Team Member:" . $row2['vMember5'] . "</p>";
                }
                if ($row2['vMember6'] != '') {
                  echo "<p>Inspection Team Member:" . $row2['vMember6'] . "</p>";
                }
              ...
              <tbody>";
                ...
                <th scope='row'>6</th>
                <td>Power backup</td>
                <td>" . $row2['powerBackup'] . "</td>
              </tr>
              <tr>
              <th scope='row'>7</th>
              <td>Mobile Usage</td>
              <td>" . $row2['mobileUsage'] . "</td>
              </tr>
              <tr>
              <th scope='row'>8</th>
              <td>Outing</td>
              ...
              <th scope='row'>9</th>
              <td>Money Matters</td>
              <td>" . $row2['moneyMatters'] . "</td>
              </tr>
              <tr>
              <th scope='row'>10</th>
              <td>Documents</td>
              <td>" . $row2['documents'] . "</td>
              </tr>
              <tr>
              <th scope='row'>11</th>
              <td>Mentor connection</td>
              <td>" . $row2['mentorConn'] . "</td>
              </tr>
              <tr>
              <th scope='row'>12</th>
              <td>Time Table Availability</td>
              <td>" . $row2['timeTable'] . "</td>
              </tr>
              <tr>
              <th scope='row'>13</th>
              <td>C.C Camera</td>
              <td>" . $row2['ccCamera'] . "</td>
                ...
                ";
                $i = 13;
                if ($row2['observation1'] != '') {
                  echo "<tr>
                  <th scope='row'>" . $i . "</th>
                  <td>Observation 1</td>
                  <td>" . $row2['observation1'] . "</td>
                  </tr>";
                  $i = $i + 1;
                }
                if ($row2['observation2'] != '') {
                  echo "<tr>
                  <th scope='row'>" . $i . "</th>
                  <td>Observation 2</td>
                  <td>" . $row2['observation2'] . "</td>
                  </tr>";
                  $i = $i + 1;
                }
                if ($row2['observation3'] != '') {
                  echo "<tr>
                  <th scope='row'>" . $i . "</th>
                  <td>Observation 3</td>
                  <td>" . $row2['observation3'] . "</td>
                  </tr>";
                  $i = $i + 1;
                }
                if ($row2['observation4'] != '') {
                  echo "<tr>
                  <th scope='row'>" . $i . "</th>
                  <td>Observation 4</td>
                  <td>" . $row2['observation4'] . "</td>
                  </tr>";
                  $i = $i + 1;
                }
                echo "  </tbody>
              ...
              echo "<div class='no-record w-100 h-75  d-flex align-content-center justify-content-center'>
