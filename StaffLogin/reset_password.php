...
function send_email($email, $name, $jwt)
{
  ...
  try {
    ...
    $mail->Body    = "Here is your reset link its is valid up to 5 minutes<br> <a href='http://localhost/PGManagement/StaffLogin/reset_password_code.php?token=$jwt&email=$email'>Click here</a>";
    $mail->AltBody = 'http://localhost/PGManagement/StaffLogin/reset_password_code.php?token=$jwt&email=$email';
